...
# https://github.com/E869120/kyopro_educational_90/blob/main/sol/035-03.cpp
...
for _ in range(Q):
    ...
    if verts == 3:
        ...
        vy = lca(vb, vc)
        vz = lca(vc, va)
        print(depth[va] + depth[vb] + depth[vc] - depth[vx] - depth[vy] - depth[vz])